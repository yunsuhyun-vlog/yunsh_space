...
// #define SYS_CLK 100000000  // 시스템 클럭 100MHz

// // 속도 설정 전용 함수
// void UART_SetBaud(unsigned int bps) {
//     // CPU가 C 코드 레벨에서 나눗셈을 수행하여 최종 분주 값(divider)을 계산
//     unsigned int divider = SYS_CLK / (bps * 16); 

//     // 계산된 분주 값(예: 651)을 APB 버스 하드웨어 레지스터에 기록
//     *(volatile unsigned int *) APB_UART_BAUD = divider; 
// }

// int main() {
//     // 사용자는 복잡한 계산식 없이 bps 값만 직관적으로 적으면 끝!
//     UART_SetBaud(9600);   
