...
module rv32i_datapath (
    ...
    logic [31:0]
        o_exe_rs1, o_exe_rs2, o_exe_imm;  //rs1_reg_out, rs2_reg_out,imm_reg_out
    logic [31:0]
        o_wb_rs2,
        o_exe_alu_result,
        o_mem_drdata;  //wb_rs2_reg_out, alu_reg_out,drdata_reg_out
    logic [31:0] o_wb_auipc;


    assign bus_addr  = o_exe_alu_result;
    assign bus_wdata = o_wb_rs2;
...
module program_counter (
    ...
    logic [31:0] pc_next, rs2_or_pc_out, o_exe_pc_next;
    logic pc_nn_sel;
    ...
    register U_PC_REG_MEM (
        .clk(clk),
        .rst(rst),
        .data_in(pc_next),
        .data_out(o_exe_pc_next)
    );
    register_en U_PC_REG_EN (
        .clk(clk),
        .rst(rst),
        .en(pc_en),
